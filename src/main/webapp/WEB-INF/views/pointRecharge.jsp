        ...
        <div class="row mb-4 table-aligned">
            <div class="col-md-12">
                ...
                <div class="point-options">
                    <div><input type="radio" name="point" id="point1000" value="1000"> <span>1,000 Point</span> <span>1,000원</span></div>
                    <div><input type="radio" name="point" id="point3000" value="3000"> <span>3,000 Point</span> <span>3,000원</span></div>
                    <div><input type="radio" name="point" id="point5000" value="5000"> <span>5,000 Point</span> <span>5,000원</span></div>
                    <div><input type="radio" name="point" id="point10000" value="10000"> <span>10,000 Point</span> <span>10,000원</span></div>
                    <div><input type="radio" name="point" id="point30000" value="30000"> <span>30,000 Point</span> <span>30,000원</span></div>
                    <div><input type="radio" name="point" id="point50000" value="50000"> <span>50,000 Point</span> <span>50,000원</span></div>
                </div>
            </div>
        </div>
        ...
        <div class="row mb-4 table-aligned">
            <div class="col-md-12 text-right">
                <div class="current-point">
                    <p>현재 포인트: <span><%= application.getAttribute("userPoint") != null ? application.getAttribute("userPoint") : 0 %>P</span></p>
                    <p>충전 후 포인트: <span id="totalPoints"><%= application.getAttribute("userPoint") != null ? application.getAttribute("userPoint") : 0 %>P</span></p>
                </div>
            </div>
        </div>
