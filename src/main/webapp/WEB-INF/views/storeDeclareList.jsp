...
<body>
<script src="${pageContext.request.contextPath}/resources/assets/js/storeDeclareList.js" defer></script>
                                            ...
                                            <tr>
                                              ...
                                              <td>
                                                <c:if test="${storeTipOffList.storeSecret == 'Y'}">
                                                    ...
                                                    <button class="btn btn-danger storeTipOffList">승인</button>
                                                </c:if>
                                                  <c:if test="${storeTipOffList.storeSecret == 'N'}">
                                                  <button class="btn" type="button">승인 완료</button>
                                                </c:if>
                                              </td>
                                            </form>
                                                <!--승인 -->
                                                <%--<td>
                                                    <div class="d-grid gap-2 d-md-block">
                                                        <button class="btn btn-danger" type="button"
                                                                id="storeTipOffList">공개전환
                                                        </button>
                                                        <button class="btn btn-primary" type="button"
                                                                id="deleteStoreTipOffList">제보삭제
                                                        </button>
                                                    </div>
                                                </td>--%>
                                            </tr>
