      ...
      <div class="container">
        <div class="page-inner"> <!-- 페이지 내부 -->
          <div class="page-header">
            <h3 class="fw-bold mb-3">가게 등록 제보</h3> <!-- 페이지 제목 -->
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="card">
                <!-- 카드 내용 부분 -->
                <div class="card-body">
                  <div class="table-responsive"> <!-- 테이블을 감싸는 div 추가 -->
                    <table class="table table-hover" style="text-align: center;"><!--현재 확인하고 있는 행 확인 위한 호버-->
                      <thead>
                        <tr><!--1열 : 상품주문내역 정보 카테고리-->
                          <th scope="col">고유번호</th>
                          <th scope="col">제보일자</th>
                          <th scope="col">상호명</th>
                      ...
                      <tbody>
                        <c:forEach var="data" items="${datas}">
                          <tr>
                            <td>${data.고유번호}</td> <!--고유번호-->
                            <td>${data.제보일자}</td> <!--제보일자-->
                            <td>${data.상호명}</td> <!--상호명-->
                            <td>${data.가게 전화번호}</td> <!--가게 전화번호-->
                            <td>${data.가게주소}</td> <!--가게주소-->
                            <td><button class="btn btn-danger" id="">승인</button></td> <!--승인 -->
                          </tr>
                        </c:forEach>
                      </tbody>
                    </table>
