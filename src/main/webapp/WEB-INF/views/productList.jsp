 ...
 <div id="page-wrapper">
        ...
        <form action="loadListProduct.do" method="GET">
            <div class="search-container">
                ...
                <div class="search-box">
                    ...
                    <button class="btn btn-dark" id="searchButton" type="submit"><i class="fas fa-search"></i>검색</button>
                </div>
                <div class="selected-options mt-3" id="selectedOptions"></div>                       
                <div class="search-options" id="searchOptions" style="display: none;">
                    <div class="filter-section mt-3">
                        <h5><i class="fas fa-key"></i>검색 키워드 입력</h5>
                    ...
                    <div class="price-section mt-4">
                        <h5><i class="fas fa-dollar-sign"></i>가격 설정</h5>
                    ...
                    <div class="category-section mt-4">
                        <h5><i class="fas fa-tags"></i>카테고리 설정</h5>
	...
	<section id="recent-products-section">
        ...
        <div class="pagination">
            <c:if test="${page > 1}">
                <a href="?page=${page - 1}&categoryNum=${param.categoryNum}&minPrice=${minPrice}&maxPrice=${maxPrice}&searchCondition=${searchCondition}&keyword=${keyword}">
                    &laquo; 이전
                </a>
            </c:if>
            ...
            <c:forEach var="i" begin="1" end="${pageCount}">
                <c:choose>
                    ...
                    <c:otherwise>
                        <a href="?page=${i}&categoryNum=${param.categoryNum}&minPrice=${minPrice}&maxPrice=${maxPrice}&searchCondition=${searchCondition}&keyword=${keyword}">
                            ${i}
                        </a>
                    </c:otherwise>
                </c:choose>
