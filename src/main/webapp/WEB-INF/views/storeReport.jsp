				...
				<form id="storeRegister" action="addStore.do" method="POST">
					...
					<div class="row">
						<section>
							...
							<!--2행 주소검색데이터 불러오기-->
							<div>
								<input type="text" name="storeAddress" id="addressMain" required
									placeholder="주소검색버튼을 눌러주세요." readonly></input> <br> <br>
								<input type="text" id="postcode" required placeholder="우편번호 입력"
									readonly></input> <br> <br> <input type="text"
									name="storeAddressDetail" id="addressDetail" required
									placeholder="상세주소 입력"></input>
							</div>
						</section>
					</div>
						...
						<div class="col-12 col-md-6">
							<section>
								...
								<table class="menuTable" id="menuTable">
									...
									<tr>
										<td><input type="checkbox" name="storeMenuMini" id="mini"
											value="Y" data-role="businessMenusGroup">미니 붕어빵 <input
											type="hidden" name="storeMenuMini" id="nonChecked-mini"
											value="N"></td>
						...
						<section>
							...
							<table id="weekTable">
								<tr>
									...
									<td><input type="time" id="endTime-Mon" name="workEndTime"
										disabled></td>
								</tr>
								<tr>
									...
									<td><input type="time" id="startTime-Tue"
										name="workStartTime" disabled></td>
									<td><input type="time" id="endTime-Tue" name="workEndTime"
										disabled></td>
								</tr>
								<tr>
									...
									<td><input type="time" id="startTime-Wed"
										name="workStartTime" disabled></td>
									<td><input type="time" id="endTime-Wed" name="workEndTime"
										disabled></td>
								</tr>
								<tr>
									...
									<td><input type="time" id="startTime-Thu"
										name="workStartTime" disabled></td>
									<td><input type="time" id="endTime-Thu" name="workEndTime"
										disabled></td>
								</tr>
								<tr>
									...
									<td><input type="time" id="startTime-Fri"
										name="workStartTime" disabled></td>
									<td><input type="time" id="endTime-Fri" name="workEndTime"
										disabled></td>
								</tr>
								<tr>
									...
									<td><input type="time" id="startTime-Sat"
										name="workStartTime" disabled></td>
									<td><input type="time" id="endTime-Sat" name="workEndTime"
										disabled></td>
								</tr>
								<tr>
									...
									<td><input type="time" id="startTime-Sun"
										name="workStartTime" disabled></td>
									<td><input type="time" id="endTime-Sun" name="workEndTime"
										disabled></td>
								</tr>
							</table>
						</section>
