...
public class StoreWorkDAO {
	...
	public boolean update(StoreWorkDTO storeWorkDTO) {
		...
		try{
			...
			pstmt.setString(1, storeWorkDTO.getStoreWorkOpen());
			pstmt.setString(2, storeWorkDTO.getStoreWorkClose());
			pstmt.setInt(3, storeWorkDTO.getStoreNum());
			pstmt.setString(4, storeWorkDTO.getStoreWorkWeek());
