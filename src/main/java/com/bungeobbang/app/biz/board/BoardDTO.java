...
public class BoardDTO {
	...
	public void setBoardFolder(String boardFolder) {
		this.boardFolder = boardFolder;
	}
	@Override
	public String toString() {
		return "BoardDTO [boardNum=" + boardNum + ", boardTitle=" + boardTitle + ", boardContent=" + boardContent
				+ ", boardFolder=" + boardFolder + ", memberNum=" + memberNum + ", boardWriteDay=" + boardWriteDay
				+ ", boardOpen=" + boardOpen + ", boardCateNum=" + boardCateNum + ", storeNum=" + storeNum
				+ ", boardDelete=" + boardDelete + ", likeCnt=" + likeCnt + ", memberNickname=" + memberNickname
				+ ", boardCateName=" + boardCateName + ", condition=" + condition + ", filterList=" + filterList
				+ ", startNum=" + startNum + ", endNum=" + endNum + ", cnt=" + cnt + ", maxPk=" + maxPk + "]";
	}
