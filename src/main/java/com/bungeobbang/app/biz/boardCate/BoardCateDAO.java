...
public class BoardCateDAO {
	...
	private final String SELECTALL = "SELECT CATEGORY_NUM, CATEGORY_NAME FROM BB_BOARD_CATEGORY WHERE CATEGORY_NAME = ? ORDER BY CATEGORY_NUM";
	...
	public ArrayList<BoardCateDTO> selectAll(BoardCateDTO boardCateDTO) {
		...
		try {
			...
			pstmt.setString(1, boardCateDTO.getBoardCateName());
