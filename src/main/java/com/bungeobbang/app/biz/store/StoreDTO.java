...
public class StoreDTO {
	...
	public String toString() {
		return "StoreDTO [storeNum=" + storeNum + ", storeName=" + storeName + ", storeDefaultAddress="
				...
				+ storePhoneNum + ", storeClosed=" + storeClosed + ", storeSecret=" + storeSecret + ", storeDeclared="
				+ storeDeclared + ", storeClosedCnt=" + storeClosedCnt + ", filterList=" + filterList + ", condition="
				+ condition + ", startNum=" + startNum + ", endNum=" + endNum + ", cnt=" + cnt + "]";
	}
}